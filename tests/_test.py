...
os.system(f'python -m pygetpapers1.pygetpapers1 -q "lantana" -k 5 -o "{current_path}"')
...
def test_eupmc_does_update_work():
    ...
    os.system(f'python -m pygetpapers1.pygetpapers1 -q "lantana" -k 10 --update -o {current_path}')
    path, dirs, files = next(os.walk(current_path))
...
def test_does_zip_work():
    print("checking zip")
    os.system(f'python -m pygetpapers1.pygetpapers1 -q {paper_for_zip} -o {current_path} -k 1 --zip')
...
def test_does_supplementary_work():
    print("checking supp")
    os.system(f'python -m pygetpapers1.pygetpapers1 -q {paper_for_supp} -o {current_path} -k 1 --supp')
...
def does_references_work():
    ...
    os.system(
        f'python -m pygetpapers1.pygetpapers1 -q {paper_for_references_test} -o {current_path} -k 1 --supp')
...
def does_citations_work():
    ...
    os.system(
        f'python -m pygetpapers1.pygetpapers1 -q {paper_for_citations_test} -o {current_path} -k 1 --supp')
...
def test_does_crossref_work():
    os.system(
        f'python -m pygetpapers1.pygetpapers1 -q "lantana" -k 5 -o "{current_path}" --api "crossref" ')
    print("Checking if query run successfully")
...
def test_does_arxiv_work():
    os.system(
        f'python -m pygetpapers1.pygetpapers1 -q "lantana" -k 5 -o "{current_path}" --api "arxiv" ')
    print("Checking if query run successfully")
...
def test_does_logfile_work():
    os.system(
        f'python -m pygetpapers1.pygetpapers1 -q lantana -o "{current_path}" -k 1 --logfile {logfile_name}')
...
def test_does_biorxiv_work():
    os.system(
        f'python -m pygetpapers1.pygetpapers1 -k 5 -o "{current_path}" --api "biorxiv" ')
    print("Checking if query run successfully")
